...
export function UploadModal({ onClose }: Props) {
  ...
  function publish() {
    onClose();
    alert(`🎉 "${title || "Untitled"}" published successfully!`);
  }
      ...
      <div className="modal-box">
        ...
        {step === 1 && (
          <>
            <label
              htmlFor="fileInput"
              style={{ border: "2px dashed var(--bg4)", borderRadius: 10, padding: 36, textAlign: "center", cursor: "pointer", display: "block", transition: "border-color .2s", marginBottom: 14 }}
          ...
          <>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <select className="finput" value={cat} onChange={(e) => setCat(e.target.value)}>
                {["Gaming","Music","Tech","Science","Education","Comedy","Sports","News","Cooking","Travel"].map((c) => (
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 14 }}>
              ...
              <button className="fbtn red" onClick={publish}>Publish</button>
            </div>
          </>
        )}
      </div>
